...
public class Converter {
    ...
    RateFetcher conversion;

    public Converter(RateFetcher conversion) {
    ...
    public void almacenarValores(String monedaBase, String monedaObjetivo){
        ...
        System.out.println("Ingrese el valor  desea convertir");
    ...
    public void almacenarValoresPersonalizados(){
        ...
        this.monedaBase = lectura.nextLine().toUpperCase();

        System.out.println("Ingrese la moneda objetivo:");
        this.monedaObjetivo = lectura.nextLine().toUpperCase();
    ...
    public String obtenerMensajeRespuesta() {
        ...
        if (resultado.startsWith("Error")) {
            System.out.println(resultado); // Imprime el mensaje de error directamente
            return resultado; // Retorna el mensaje de error
        } else {
            String[] partes = resultado.split("equivale a");
            String conversionInfo = partes[0].trim();
            String conversionAmount = partes[1].trim();

            System.out.println(String.format("%s equivale a: %s", conversionInfo, conversionAmount));
            return String.format("%s equivale a: %s", conversionInfo, conversionAmount);
        }
    }
